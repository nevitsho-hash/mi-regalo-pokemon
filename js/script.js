// Usamos rutas que empiezan desde la carpeta principal del proyecto
const sonidoBoton = new Audio('/mi-regalo-pokemon/assets/sng/clic.mp3');
const sonidoCaptura = new Audio('/mi-regalo-pokemon/assets/sng/captura.wav');
...
// ... El resto del código de activarEscaner() se queda igual ...

function actualizarPantalla(data) {
    sonidoCaptura.play().catch(() => console.log("Sonido bloqueado"));

    document.getElementById('reader').style.display = 'none';
    document.getElementById('pokedex-content').style.display = 'flex';
    document.getElementById('main-text').innerHTML = data.text;
    
    // Cambiamos la imagen forzando la ruta limpia
    const imgElement = document.getElementById('main-sprite');
    imgElement.src = data.sprite;
    
    console.log("Intentando cargar:", data.sprite);
}
